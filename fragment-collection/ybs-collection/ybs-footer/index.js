/* Yorkshire Building Society Footer Fragment JavaScript */
(function() {
    'use strict';
    ...
    function initializeFooter() {
        // Yorkshire Building Society Footer Fragment initializing
        ...
        // Yorkshire Building Society Footer Fragment initialized
    }
    ...
    function getFragmentConfiguration() {
        ...
        if (typeof configuration !== 'undefined') {
            config = {
                ...
                companyName: configuration.companyName || 'Yorkshire Building Society',
    ...
    function applyConfiguration(config) {
        const footer = fragmentElement.querySelector('.ybs-footer');
        const newsletterSection = fragmentElement.querySelector('#ybs-newsletter-section');
        const socialMediaSection = fragmentElement.querySelector('.ybs-footer-social');
        const backToTopBtn = fragmentElement.querySelector('.ybs-back-to-top-btn');
        const companyNameElements = fragmentElement.querySelectorAll('.ybs-company-name');
        const footerColumns = fragmentElement.querySelector('.ybs-footer-main');
        // Apply footer style
        if (footer) {
    ...
    function initializeNewsletter() {
        const newsletterForm = fragmentElement.querySelector('#ybs-newsletter-form');
        const newsletterSection = fragmentElement.querySelector('#ybs-newsletter-section');
    ...
    function handleNewsletterSubmission(e) {
        ...
        const submitBtn = form.querySelector('.ybs-newsletter-btn');
    ...
    function showNewsletterMessage(message, type) {
        ...
        const existingMessage = fragmentElement.querySelector('.ybs-newsletter-message');
        if (existingMessage) {
        ...
        messageElement.className = `ybs-newsletter-message ybs-newsletter-message-${type}`;
        messageElement.textContent = message;
        messageElement.setAttribute('role', 'alert');
        
        // Insert message
        const form = fragmentElement.querySelector('#ybs-newsletter-form');
        if (form) {
    ...
    function initializeAccessibility() {
        ...
        const socialLinks = fragmentElement.querySelectorAll('.ybs-social-link');
